...
class FlyweightFactory(object):
    ...
    flyweight, the FlyweightFactory object supplies an exiting instance
    or creates one, if none exits.
    """
...
class Flyweight(metaclass=abc.ABCMeta):
    """
    Declare an interface through which flyweights can reveive and act on extrinsic state.
    """

    def __init__(self):
        self.instrinsic_state = None
